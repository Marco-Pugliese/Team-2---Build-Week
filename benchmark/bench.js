const benchObj = [
    ...
    {
        question:"Quale metodo buil.in combina il testo di due stringhe e restituisce una nuova stringa?"
        a:"attach()",
        b:"append()",
        c:"concat()",
        d:"None of the above",
    ...
    {
        question:"Come si scrive uno statement IF che controlli se i è uguale a 5 in Javascript?",
        a:"if(i=5){}",
        b:"if(i===5){}",
        c:"if i==5 then",
        d:"if i=5 then",
    ...
    {
        question:"Quando si seleziona un elemento nel DOM con Javascript,si può ottenere o impostare ogni regola CSS con la sua proprietà di stile.",
        a:"Vero",
        b:"Falso",
        correct:"a",
    }
    ...
    {
        question:"Quale parola chiave devo usare per dichiarare una variabile in Javascript?",
        a:"string",
        b:"let",
        c:"concat",
        d:"id",
...
const deselectAnswer = () => {answerElements.forEach((answer.checked = false));};
/*funzione che cancella la selezione precedente prima di passare alla domada successiva*/

const getSelected = () => {
    let answer;
    answerElements.forEach((answerElement)=>{if (answerElement.checked) answer = answerElement.id;});
    return answer;
}
